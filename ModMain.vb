...
Public Module ModMain
    ...
    'mac 2020-07-23
    Public Function RMJExecute(ByVal WorkingDIR As String, ByVal ProcessPath As String, ByVal FileName As String) As Integer
        Dim objProcess As System.Diagnostics.Process
...
endProc:
    ...
    Public Function getValidDate(ByVal foAppDriver As GRider, ByVal foDate As Object) As Date
        Dim lnAllow As Integer

        getValidDate = foAppDriver.getSysDate

        If IsDate(foDate) Then
